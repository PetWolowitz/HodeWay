...
export async function generateItineraryPDF(
  ...
  const transportsContent =
    options.includeTransports && itinerary.transports
    ...
    stack: [
      ...
      },
      {
        columns: [
          ...
          {
            text: `${format(
              new Date(destination.start_date),
              "MMM d"
        ...
        columns: [
          {
            stack: [
              ...
              {
                text: format(departureTime, "HH:mm, MMM d"),
                margin: [0, 2],
              },
              { text: transport.departure.location },
              transport.departure.terminal
                ? {
                    text: `Terminal: ${transport.departure.terminal}`,
                    italics: true,
                  }
                : {},
            ],
          },
          {
            stack: [
              ...
              {
                text: format(arrivalTime, "HH:mm, MMM d"),
                margin: [0, 2],
              },
              { text: transport.arrival.location },
              transport.arrival.terminal
                ? {
                    text: `Terminal: ${transport.arrival.terminal}`,
                    italics: true,
                  }
                : {},
            ],
